...
export default function TableFilters({ query, onQueryChange, searchEnabled, searchPlaceholder = 'Search hostname, model or asset ID', definitions, values, onFilterChange, onReset }) {
